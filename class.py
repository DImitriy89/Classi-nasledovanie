...
first_student = Student("Дмитрий", "Яковлев", "м")
first_student.finished_courses += ["Java"]
first_student.courses_in_progress += ["GIT"]
first_student.courses_in_progress += ["Python"]

second_student = Student("Тимур", "Константинов", "м")
second_student.courses_in_progress += ["Python"]
second_student.finished_courses += ["C++"]

first_lecturer = Lecturer("Антон", "Крутин")
first_lecturer.courses_attached += ["Python"]
first_lecturer.courses_attached += ["GIT"]

second_lecturer = Lecturer("Лука", "Дебров")
second_lecturer.courses_attached += ["GIT"]

first_reviewer = Reviewer("Николай", "Примаков")
first_reviewer.courses_attached += ["Python"]

second_reviewer = Reviewer("Андрей", "Волошин")
...
print(f"Средняя оценка за дз у Яковлева больше, чем у Константинова {second_student < first_student}")
print(f"Средняя оценка за лекции у Крутина меньше, чем у Деброва {second_lecturer < first_lecturer}\n")
